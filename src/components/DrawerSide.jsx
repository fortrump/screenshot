    ...
    >
      <div className="flex flex-col gap-2 h-full overflow-hidden">
        ...
        <div className="h-0 flex-1 overflow-y-auto px-4 py-2">
          ...
          {!photoUrl && (
            <div className="text-xs p-1 text-center text-gray-400">
              ✨ Generate Colors from your image
            </div>
          )}
          {photoUrl && (
            <>
              <div className="flex gap-3 items-center mb-2">
                <div
                  className="overflow-hidden p-[1px] border"
          ...
          />
          <div className="py-3">
            <h4 className="text-sm font-bold mb-2">Custom Background</h4>
            <BackgroundSelect
              type="custom"
              onChange={onSelectChange}
              value={value}
